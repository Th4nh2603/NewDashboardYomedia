/** Demo format Video: fixed relative path for tvc.mp4 (SFTP + ZIP offline). */
export const VIDEO_DEMO_FIXED_REL_PATH = "tvc.mp4";

export const MAKE_VAST_XML_FILENAME = "make-vast.xml";

const DEMO_PUBLIC_VIDEO_ORIGIN = "https://demo.yomedia.vn";

/** VAST 2.0 InLine defaults for Yomedia video demos. */
const VAST_AD_ID = "239e6a5992e5442c836c1980894e8dc0";
const VAST_SKIP_OFFSET = "00:00:05";
const VAST_DURATION = "00:00:15";
const VAST_CLICK_THROUGH_URL = "https://www.yomedia.vn/";
...
/**
 * VAST 2.0 for make-vast.xml.
 * `targetDemoPath` is the public path segment (e.g. 2026/04/brand/.../tvc).
 */
        ...
        <InLine>
            ...
            <Creatives>
                <Creative sequence="1" AdID="">
                    <Linear skipoffset="${VAST_SKIP_OFFSET}">
                        <Duration>${VAST_DURATION}</Duration>
                        <TrackingEvents>
                        ...
                        <VideoClicks>
                            <ClickThrough><![CDATA[${VAST_CLICK_THROUGH_URL}]]></ClickThrough>
                        </VideoClicks>
                        <MediaFiles>
