...
import "./index.css";
import { clerkAppearance } from "@/app/clerkTheme";
...
function ConfigIssueScreen({ missingKeys }: ConfigIssueProps): React.JSX.Element {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6">
      <div className="w-full max-w-2xl rounded-2xl border border-amber-400/30 bg-slate-900 shadow-2xl p-6 space-y-4">
        <h1 className="text-xl font-semibold text-amber-300">Configuration error</h1>
