...
} from "../../auth/lib/manageDemoMediaSftp.js";
import { assertCreativeShowcaseDownloadAllowed } from "../../auth/lib/creativeShowcaseDownload.js";
import {
...
} from "../../auth/lib/sftpMutate.js";
import { requireClerkAuth } from "../../auth/lib/clerkAuth.js";
import { assertBuildDemoBrandSftpAccess, assertAdminDemoSftpDeleteAllowed } from "../../auth/lib/buildDemoBrandAccess.js";

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
const SFTP_DIR_MAP_JSON_PATH = path.join(
  __dirname,
  "..",
  "..",
  "data",
