...
import { getBrandLabel } from "./config.js";
import {
  normalizeBuildDemoInput,
  resolveTargetRelativePath,
} from "./common.js";
import { executeCompressAndUpload } from "./compress.js";
import { executeUploadSftp } from "./upload.js";
import {
  buildDefaultVideoPreviewLinks,
  buildYomediaDemoPreviewUrl,
  type VideoPreviewLink,
} from "../../creative/services/preview.service.js";
